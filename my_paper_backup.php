...
<body>
    ...
    <div class="objective">
      ...
      <div>
        ...
        //mcqs insertion start
          $mcqs_insert="INSERT INTO `past_paper`( `uid`, `author_name`, `subject`, `session`, `program`, `course_code`, `mcqs_no`) VALUES ('$id','$author_name','$subject','$session','$program','$course_code','$mcqs_id')";
  ...
  //mcqs end
         ...
         if(isset($_POST['submit']))
    {
      ...
      $long_insert="INSERT INTO `past_paper`(`long_ques_no`) VALUES ('$long_ques_id')";
         ...
         if(isset($_POST['submit']))
    {
      ...
      $short_insert="INSERT INTO `past_paper`(`short_ques_no`) VALUES ('$short_ques_id')";
