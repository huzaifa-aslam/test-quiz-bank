...
<body>
      ...
      <div style="width: 424px;">
        <h1 class="my_heading">REGISTER YOUR SELF.</h1>
      </div>
      ...
      <table>
       <tr>
           <td>Your Status :
              ...
              <select class="box_shdow" required="required" name="status">
                <option></option>
  ...
  <div class="form-container sign-in-container">
    <form action="" method="POST" >
      ...
      <a href="forgot_pwd.php">Forgot your password?</a>
...
<?php
    ...
    if(isset($_POST['sign_in']))
    {
      ...
      else
      {
        echo "<script>alert('Email or/and password are not matched !! try again')</script>";
         echo "<script>winow.alert('index.php','_SELF')</script>";
   ...
   if(isset($_POST['sign_up']))
  {
    ...
    {
        $query_2="INSERT INTO `users`(`name`,`status`, `email`, `password`, `image`, `member_since`, `last_login`, `reg_code`) VALUES ('$user_name','$status','$user_email','$user_password','$user_image',NOW(),NOW(),'$reg_code')";
