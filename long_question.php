...
<?php include('includes/marquee_tag.php');?>
  <section id="long_question" class="margin_20px ">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <form action="long_question.php?uid=<?php echo $id;?>" method="POST">
            <table>
                   <tr>
               <td class="txt_align">
                  ...
                  <select required="required" name="subject" class="box_shdow">
              ...
              <tr>
                <td><h2 class="my_heading">Write a  Question.</h2></td>
        ...
        if(isset($_POST['submit']))
    {
      ...
      $subject=$_POST['subject'];
       //checking repeatition start
        $check_query="SELECT `question` FROM `long_question` WHERE `question`='$question' and `subject`='$subject'";
      ...
      //checking repeation end
       $query_2="INSERT INTO `long_question`(`subject`, `question`, `author_name`, `user_id`, `time`) 
